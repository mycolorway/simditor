...
Simditor = (function(superClass) {
  ...
  Simditor.prototype._init = function() {
    var e, editor, form, uploadAgain, uploadOpts;
    ...
    if (form.length) {
      uploadAgain = this._t('uploadAgain');
      ...
      return form.on('reset.simditor-' + this.id, (function(_this) {
        return function() {
...
Simditor.i18n = {
  'zh-CN': {
    ...
    'uploadImage': '上传图片',
    'uploadFailed': '上传失败了',
    'uploadAgain': '红框标记的图片上传失败了，请重新上传这些图片后再保存',
    'uploadError': '上传出错了',
    'imageUrl': '图片地址',
    'imageSize': '图片尺寸',
    'imageAlt': '图片描述',
  ...
  'en-US': {
    ...
    'uploadAgain': 'Upload failed, please re-upload before saving',
