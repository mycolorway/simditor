...
(function() {
  ...
  LinkButton = (function(_super) {
    ...
    LinkButton.prototype.command = function(text, url) {
      ...
      if (this.active) {
        ...
        if (text && url) {
          this.editor.selection.setRangeAtEndOf($link);
          this.editor.trigger('valuechanged');
          return;
        }
  ...
  ImageButton = (function(_super) {
    ...
    ImageButton.prototype.command = function(src) {
      ...
      return this.loadImage($img, src || this.defaultImage, function() {
        _this.editor.trigger('valuechanged');
        if (src) {
          _this.editor.selection.setRangeAtEndOf($img.parent().next());
          return;
        }
        $img.mousedown();
