...
Simditor = (function(superClass) {
  ...
  Simditor.prototype._init = function() {
    ...
    this._render();
    if (simpleHotkeys || simple.hotkeys) {
      this.hotkeys = simpleHotkeys || simple.hotkeys({
        el: this.body
      });
    } else {
    ...
    if (this.opts.upload && (simpleUploader || simple.uploader)) {
      uploadOpts = typeof this.opts.upload === 'object' ? this.opts.upload : {};
      this.uploader = simpleUploader(uploadOpts) || simple.uploader(uploadOpts);
    }
  ...
  Simditor.prototype.disabled = function() {
  ...
  Simditor.prototype.setHeight = function(height) {
    if (!!height) {
      return;
    }
