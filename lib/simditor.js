(function() {
  ...
  ImagePopover = (function(_super) {
    ...
    ImagePopover.prototype.render = function() {
      ...
      this.el.find('.image-size').on('blur', function(e) {
      ...
      this.el.find('.image-size').on('keydown', function(e) {
        var inputEl;
        inputEl = $(e.currentTarget);
        if (e.which === 13 || e.which === 27) {
          e.preventDefault();
    ...
    ImagePopover.prototype._restoreImg = function() {
      var size, _ref13;
      size = ((_ref13 = this.target.data('image-size')) != null ? _ref13.split(",") : void 0) || [this.width, this.height];
      this.target.attr({
        width: size[0] * 1,
        height: size[1] * 1
      });
