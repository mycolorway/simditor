(function() {
  ...
  ListButton = (function(_super) {
    ...
    ListButton.prototype.command = function(param) {
      var $breakedEl, $contents, $endBlock, $furthestEnd, $furthestStart, $startBlock, endLevel, endNode, getListLevel, node, range, results, startLevel, startNode, _i, _len, _ref5,
        _this = this;
      range = this.editor.selection.getRange();
      startNode = range.startContainer;
      endNode = range.endContainer;
