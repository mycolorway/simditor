...
InputManager = (function(_super) {
  ...
  InputManager.prototype._onInput = function(e) {
    if (this._typing) {
      ...
      return this._typing = setTimeout((function(_this) {
        return function() {
          _this.editor.trigger('valuechanged', ['oninput']);
      ...
      setTimeout((function(_this) {
        return function() {
          return _this.editor.trigger('valuechanged', ['oninput']);
        };
      })(this), 10);
      return this._typing = true;
    }
  };
