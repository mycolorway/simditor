(function() {
  var BlockquoteButton, BoldButton, Button, CodeButton, CodePopover, Formatter, HrButton, ImageButton, ImagePopover, IndentButton, InputManager, ItalicButton, LinkButton, LinkPopover, ListButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  InputManager = (function(_super) {
    ...
    InputManager.prototype._onKeyDown = function(e) {
      var $blockEl, $br, $prevBlockEl, $rootBlock, metaKey, result, shortcutKey, _ref, _ref1,
        _this = this;
      ...
      if (e.which === 8) {
        ...
        if ($prevBlockEl.is('hr') && this.editor.selection.rangeAtStartOf($rootBlock)) {
  ...
  Button = (function(_super) {
    ...
    function Button(editor) {
      ...
      this.el.on('mousedown', function(e) {
        ...
        e.preventDefault();
        if (_this.menu) {
          _this.wrapper.toggleClass('menu-on');
          return false;
        }
