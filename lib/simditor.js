(function() {
  ...
  Selection = (function(_super) {
    ...
    Selection.prototype._init = function() {
      var _this = this;
      return this.editor.on('selectionchanged focus', function(e) {
        var $container, range;
        ...
        if (range.collapsed && $container.is('.simditor-body') && _this.editor.util.isBlockNode($container.children())) {
  ...
  TableButton = (function(_super) {
    ...
    TableButton.prototype.initResize = function($table) {
      ...
      return $wrapper.on('mousedown', '.resize-handle', function(e) {
        var $col, $handle, $td, maxWidth, minWidth, startLeft, startWidth, startX;
