(function() {
  ...
  Formatter = (function(_super) {
    ...
    Formatter.prototype._allowedTags = ['a', 'img', 'b', 'strong', 'i', 'u', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'];
  ...
  InputManager = (function(_super) {
    ...
    InputManager.prototype._onFocus = function(e) {
      ...
      return setTimeout(function() {
        _this.editor.trigger('simditorfocus');
    ...
    InputManager.prototype._onBlur = function(e) {
      ...
      this.editor.sync();
      this.focused = false;
      return this.editor.trigger('simditorblur');
    };
  ...
  Button = (function(_super) {
    ...
    function Button(editor) {
      ...
      this.editor.on('simditorblur', function() {
  ...
  Popover = (function(_super) {
    ...
    function Popover(editor) {
      ...
      this.render();
      this.editor.on('simditorblur.linkpopover', function() {
