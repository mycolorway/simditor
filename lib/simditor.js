...
Indentation = (function(superClass) {
  ...
  Indentation.prototype.indentText = function(range) {
    var _codeIndent, _codeIndentWidth, i, k, ref, text, textNode;
    _codeIndentWidth = this.opts.codeIndentWidth;
    if ((parseInt(_codeIndentWidth)) === _codeIndentWidth) {
      _codeIndent = '';
      for (i = k = 1, ref = _codeIndentWidth; 1 <= ref ? k <= ref : k >= ref; i = 1 <= ref ? ++k : --k) {
        _codeIndent += '\u00A0';
      }
    } else {
      _codeIndent = '\u00A0\u00A0';
