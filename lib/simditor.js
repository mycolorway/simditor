(function() {
  ...
  InputManager = (function(_super) {
    ...
    InputManager.prototype._onFocus = function(e) {
      ...
      return setTimeout(function() {
        ...
        return _this.editor.undoManager.updateCaretState();
      }, 0);
    };
    ...
    InputManager.prototype._onMouseUp = function(e) {
      ...
      return this.editor.undoManager.updateCaretState();
    };
    ...
    InputManager.prototype._onKeyUp = function(e) {
      ...
      if (_ref = e.which, __indexOf.call(this._arrowKeys, _ref) >= 0) {
        this.editor.trigger('selectionchanged');
        this.editor.undoManager.updateCaretState();
        return;
      }
  ...
  UndoManager = (function(_super) {
    ...
    UndoManager.prototype.updateCaretState = function() {
      var currentState;
      if (!(this._stack.length && this._index > -1)) {
        return;
      }
  ...
  TableButton = (function(_super) {
    ...
    TableButton.prototype.initResize = function($table) {
      var $wrapper;
      return $wrapper = $table.parent('.simditor-table');
    };
