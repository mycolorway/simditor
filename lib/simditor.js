(function() {
  ...
  Formatter = (function(_super) {
    ...
    Formatter.prototype.cleanNode = function(node, recursive) {
      var $node, $p, allowedAttributes, attr, contents, isDecoration, n, text, _i, _j, _len, _len1, _ref, _ref1,
        _this = this;
      $node = $(node);
  ...
  TableButton = (function(_super) {
    ...
    function TableButton() {
      ...
      this.editor.on('selectionchanged.table', function(e) {
        ...
        return $(range.commonAncestorContainer).closest('td', _this.editor.body).addClass('active');
      });
