...
LinkPopover = (function(superClass) {
  ...
  LinkPopover.prototype.render = function() {
    ...
    this.urlEl.on('keyup', (function(_this) {
      return function(e) {
        ...
        return _this.confirm[val ? 'removeClass' : 'addClass']('disabled');
      };
    })(this));
    ...
    this.confirm.on('click', (function(_this) {
      return function(e) {
        ...
        if (_this.confirm.hasClass('disabled')) {
          return _this.urlEl.trigger('focus');
        }
        val = _this.urlEl.val();
        if (!(/https?:\/\/|^\//ig.test(val) || !val)) {
          val = 'http://' + val;
        }
        _this.confirm[val ? 'removeClass' : 'addClass']('disabled');
  ...
  LinkPopover.prototype.show = function() {
    ...
    this.confirm[this.val ? 'removeClass' : 'addClass']('disabled');
