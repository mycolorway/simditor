...
AligncenterButton = (function(_super) {
  ...
  AligncenterButton.prototype.htmlTag = 'p, h1, h2, h3, h4';

  AligncenterButton.prototype.shortcut = 'Cmd + Shift + E';

  AligncenterButton.prototype.status = function($node) {
    if ($node == null) {
      return true;
    }
    ...
    this.setActive($node.data("align") === "center");
    return this.active;
  };
...
AlignleftButton = (function(_super) {
  ...
  AlignleftButton.prototype.htmlTag = 'p, h1, h2, h3, h4';

  AlignleftButton.prototype.shortcut = 'Cmd + Shift + L';

  AlignleftButton.prototype.status = function($node) {
    var aligment;
    if ($node == null) {
      return true;
    }
    ...
    this.setActive(aligment === void 0 || aligment === "left");
    return this.active;
  };
...
AlignrightButton = (function(_super) {
  ...
  AlignrightButton.prototype.htmlTag = 'p, h1, h2, h3, h4';

  AlignrightButton.prototype.shortcut = 'Cmd + Shift + R';

  AlignrightButton.prototype.status = function($node) {
    if ($node == null) {
      return true;
    }
    if (!this.editor.util.isBlockNode($node)) {
    ...
    this.setActive($node.data("align") === "right");
    return this.active;
  };
