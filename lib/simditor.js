(function() {
  ...
  Selection = (function(_super) {
    ...
    Selection.prototype.deleteRangeContents = function(range) {
      ...
      endRange.collapse();
      if (this.rangeAtStartOf(this.editor.body, startRange) && this.rangeAtEndOf(this.editor.body, endRange)) {
  ...
  InputManager = (function(_super) {
    ...
    InputManager.prototype._onPaste = function(e) {
      ...
      return setTimeout(function() {
        var $img, blob, children, insertPosition, node, pasteContent, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2;
        ...
        if (!pasteContent) {
          ...
          for (_j = 0, _len1 = pasteContent.length; _j < _len1; _j++) {
            node = pasteContent[_j];
