...
LinkPopover = (function(superClass) {
  ...
  LinkPopover.prototype.render = function() {
    ...
    this.selectTarget.on('change', (function(_this) {
      return function(e) {
        return _this.target.attr('target', _this.selectTarget.val());
      };
    })(this));
    this.confirm.on('click', (function(_this) {
      return function(e) {
        ...
        _this.target.attr('href', _this.urlEl.val());
        _this.editor.inputManager.throttledValueChanged();
        _this.active = true;
        return _this.hide();
      };
    ...
    return this.close.on('click', (function(_this) {
      return function(e) {
        var text;
        text = _this.val ? _this.textEl.val() : '';
        _this.target.text(text);
        _this.editor.inputManager.throttledValueChanged();
        if (!(text && _this.urlEl.val())) {
