  ...
  ImageButton.prototype._init = function() {
    ...
    if (this.editor.opts.imageButton) {
      if (Array.isArray(this.editor.opts.imageButton)) {
        ...
        this.menu = false;
        this.uploadOnly = this.editor.opts.imageButton === 'upload' ? true : false;
      }
    } else {
    ...
    if (this.uploadOnly) {
      ...
      createInput = (function(_this) {
        return function() {
          ...
          return $input = $('<input type="file" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo(_this.el);
        };
      })(this);
      createInput();
